        ...
        <div class="container">
            <div class="row">
                ...
                <?php  
                    ...
                    $sql1 = "SELECT * FROM heritage "; 
                    $rs_result1 = $conn->query($sql1); //run the query
                    $total_records = $rs_result1->num_rows;  //count number of records
                    $total_pages = ceil($total_records / $num_rec_per_page);


                    $touristplace = "SELECT * FROM heritage ORDER BY ID DESC LIMIT $start_from, $num_rec_per_page";
                    ...
                    if($Res->num_rows > 0)
                    {
                        ...
                        <div class="left" >
                                    ...
                                    <img src="images/images/HBIcon.png" height="120" style="margin-left:30%" alt=""/>
...
<div class="wrap">	
    ...
    <script lang="javascript">
	  ...
	  var smallIcon = new L.Icon({
                        ...
                        iconAnchor: [10, 20],
                        popupAnchor:  [1, -24],
                        iconUrl: 'images/images/HBmapMaker.jpg'
                    });   
	  	<?php
		  $touristplace = "SELECT * FROM heritage";
		  $Res = $conn->query($touristplace);
		  if($Res->num_rows > 0)
		  {
			  while($Rows = $Res->fetch_assoc())
			  {
				...
				$lon=$Rows['Lon'];
					...
					?>
				 marker.bindPopup('<div class="bg-dark rounded shadow-sm py-5 px-4 text-white"><img src="images/images/HBIcon.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"><h4 class="mb-0">Name: </h4><?php echo $Name?></br></br><h4 class="mb-0">Address:</h4><?php echo $Address;?></br></br><h4 class="mb-0">Rating:</h4><?php echo $Rating;?></br></div>');        
			  <?php
				}
			}
			  	?>
