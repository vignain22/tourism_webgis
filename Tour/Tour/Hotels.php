        ...
        <div class="container">
            <div class="row">
                ...
                <?php  
                    ...
                    $yogaData = "SELECT * FROM hotel ORDER BY ID DESC LIMIT $start_from, $num_rec_per_page";
                    ...
                    if($Res->num_rows > 0)
                    {
                        while($Rows = $Res->fetch_assoc())
                        {
                            ...
                            ?>
                        <div class="left">
                                    <img src="images/images/HotelIcon.jpg" height="120" style="margin-left:30%" alt=""/>
                               
                                <div class="left-text">
                                <h4 style="height:30px;"><?php echo $Rows['Name']; ?></h4>
                                <span > <h5>Phone: <?php 
                                            echo $Rows['Phone'];                                            
                                        ?></h5>
                                </span>
										<?php 
                                           echo $Rows['Category_Start'];
                                            ?> <span class="fa fa-star checked"></span> Hotel
                                        
                                <div style="height:100px;">Address:<?php echo  $Rows['Address']; ?></div></br>
                                <hr>
                            </div>
                        </div>
...
<script src="data/Hotel.js"> </script>
    <script lang="javascript">
      ...
      var HotelData =  L.geoJson(HotelData,     
      {
            pointToLayer: function(feature, latlng) {
                var smallIcon = new L.Icon({
                        ...
                        iconAnchor: [10, 20],
                        popupAnchor:  [1, -24],
                        iconUrl: 'images/images/Hotel.png'
                    });                
                return L.marker(latlng, {icon: smallIcon});
            },      
               onEachFeature:function (feature, layer) {
            layer.bindPopup('<div class="bg-dark rounded shadow-sm py-5 px-4 text-white"><img src="images/images/HotelIcon.jpg" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"><h4 class="mb-0">Name: </h4> '+feature.properties.Name+'</br></br><h4 class="mb-0">Address:</h4>'+feature.properties.address+'</br></br><h4 class="mb-0">Phone: </h4>'+feature.properties.phone+'</br><h4 class="mb-0">Stars: </h4>'+feature.properties.Star+'</br><h4 class="mb-0"> postal Code: </h4>'+feature.properties.postalCode+'</br></div>');        
        }
