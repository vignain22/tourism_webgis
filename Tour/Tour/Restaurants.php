        ...
        <div class="container">
            <div class="row">
                ...
                <?php  
                    ...
                    $yogaData = "SELECT * FROM restaurant ORDER BY ID DESC LIMIT $start_from, $num_rec_per_page";
                    ...
                    if($Res->num_rows > 0)
                    {
                        ...
                        <div class="left" >
                                    ...
                                    <img src="images/images/restrauntIcon.png" height="120" style="margin-left:30%" alt=""/>
...
<script src="data/RestaurantData.js"> </script>
    <script lang="javascript">
      ...
      var restaurantData =  L.geoJson(restaurantData,     
      {
            pointToLayer: function(feature, latlng) {
                var smallIcon = new L.Icon({
                        ...
                        iconAnchor: [10, 20],
                        popupAnchor:  [1, -24],
                        iconUrl: 'images/images/restrauntMarker.png'
                    });                
                return L.marker(latlng, {icon: smallIcon});
            },      
               onEachFeature:function (feature, layer) {
            layer.bindPopup('<div class="bg-dark rounded shadow-sm py-5 px-4 text-white"><img src="images/images/restrauntIcon.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"><h4 class="mb-0">Name: </h4> '+feature.properties.Name+'</br></br><h4 class="mb-0">Address:</h4>'+feature.properties.Address+'</br></br><h4 class="mb-0">Phone: </h4>'+feature.properties.phone+'</br><h4 class="mb-0">Rank: </h4>'+feature.properties.rank+'</br><h4 class="mb-0">Total Rating: </h4>'+feature.properties.totalScore+'</br></div>');        
        }
