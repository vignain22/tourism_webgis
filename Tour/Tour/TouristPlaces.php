        ...
        <div class="container">
            <div class="row">
                <div class="con-top">
                    ...
                    <h3>Heritage Buildings Details</h3>
                </div>
                <div class="col-lg-12" >
                <?php  
                    include('databaseconnection.php');
                    ...
                    $sql1 = "SELECT * FROM touristplace "; 
                    $rs_result1 = $conn->query($sql1); //run the query
                    $total_records = $rs_result1->num_rows;  //count number of records
                    $total_pages = ceil($total_records / $num_rec_per_page);


                    $touristplace = "SELECT * FROM touristplace ORDER BY ID DESC LIMIT $start_from, $num_rec_per_page";
                    $Res = $conn->query($touristplace);
                    if($Res->num_rows > 0)
                    {
                        ...
                        <div class="left">
                                    ...
                                    <img src="images/images/TPICON.png" height="120" style="margin-left:30%" alt=""/>
                                ...
                                <div style="height:100px;">Address:<?php echo  $Rows['Adress']; ?></div></br>
                              	<hr>
                            </div>
                        </div>                            
                            <?php							
...
<div class="wrap">	
...
</div>    <script src="data/HB.js"> </script>
    <script lang="javascript">
	  ...
	  var smallIcon = new L.Icon({
                        ...
                        iconAnchor: [10, 20],
                        popupAnchor:  [1, -24],
                        iconUrl: 'images/images/TP.png'
                    });   
	  	<?php
		  $touristplace = "SELECT * FROM touristplace";
		  $Res = $conn->query($touristplace);
		  if($Res->num_rows > 0)
		  {
			  while($Rows = $Res->fetch_assoc())
			  {
				...
				$lat=$Rows['Lat'];				
				$lon=$Rows['Lon'];
					echo "var marker = L.marker([ ".$lat.",".$lon."],{icon: smallIcon}).addTo(map);";
					?>
				 marker.bindPopup('<div class="bg-dark rounded shadow-sm py-5 px-4 text-white"><img src="images/images/TPICON.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"><h4 class="mb-0">Name: </h4><?php echo $Name?></br></br><h4 class="mb-0">Address:</h4><?php echo $Address;?></br></br><h4 class="mb-0">Rating:</h4><?php echo $Rating;?></br></div>');        
			  <?php
				}
			}
			  	?>
