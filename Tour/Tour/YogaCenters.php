        ...
        <div class="container">
            <div class="row">
                ...
                <?php  
                    ...
                    $sql1 = "SELECT * FROM yogacenter "; 
                    $rs_result1 = $conn->query($sql1); //run the query
                    $total_records = $rs_result1->num_rows;  //count number of records
                    $total_pages = ceil($total_records / $num_rec_per_page);


                    $yogaData = "SELECT * FROM yogacenter ORDER BY ID DESC LIMIT $start_from, $num_rec_per_page";
                    ...
                    if($Res->num_rows > 0)
                    {
                        ...
                        <div class="left">
                                    ...
                                    <img src="images/images/YogaBG.png" height="120" style="margin-left:30%" alt=""/>
...
</div>    <script src="data/yogaData.js"> </script>
      ...
      var yogo =  L.geoJson(yogaData,     
      {
            pointToLayer: function(feature, latlng) {
                var smallIcon = new L.Icon({
                        ...
                        iconAnchor: [13, 27],
                        popupAnchor:  [1, -24],
                        iconUrl: 'images/images/yoga.png'
                    });                
                return L.marker(latlng, {icon: smallIcon});
            },      
               onEachFeature:function (feature, layer) {
            layer.bindPopup('<div class="bg-dark rounded shadow-sm py-5 px-4 text-white"><img src="images/images/YogaBG.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"><h4 class="mb-0">Name: </h4> '+feature.properties.NAME+'</br></br><h4 class="mb-0">Address:</h4>'+feature.properties.address+'</br></br><h4 class="mb-0">Phone: </h4>'+feature.properties.phone+'</br></div>');        
        }
