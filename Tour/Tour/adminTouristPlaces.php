...
{
		  $touristplace = $_FILES['touristplace']['tmp_name'];
          $handle = fopen($touristplace, "r");
          $c = 0;
          while(($filesop = fgetcsv($handle, 1000, ",")) !== false)
          {
              ...
              $check = "SELECT * FROM touristplace WHERE Name='$Name' AND Lat='$Lat' AND Lon='$Lon'";
              ...
              {
                $sql = "INSERT INTO `touristplace`(`Name`, `Adress`, `Lat`, `Lon`, `Rating`) VALUES ('$Name','$Address','$Lat','$Lon','$Rating')";
  						  $res = $conn->query($sql);
              }
...
?>
    ...
    <div class="contact">
        ...
        <main class="col-md-12">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Upload Tourist Places Data Details</h1>            
          </div>
          <form action="adminTouristPlaces.php" method="post" enctype = "multipart/form-data">               
                <div class="form-floating">
                  <input type="file" class="form-control" name="touristplace" required>              
                </div> 
</br>               
    ...
    <hr>
		  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
			...
			<form action="adminTouristPlaces.php" method="post" enctype = "multipart/form-data">               
				<div class="row">
					<div class="col-lg-12">
						<input type="text" name="Name" class="form-control" style="background-color:#a23853;" placeholder="Tourist Name" required>
					</div>				
    ...
    <hr>
          <h2>Tourist Places Data Details</h2>
          <div class="table-responsive">
            <table class="table table-bordered table-sm">
              ...
              <tbody>
                <?php 
                 $dataretrieval = "SELECT * FROM touristplace";
                 ...
                 if($result->num_rows > 0)
                 {
                   while($dataRows=$result->fetch_assoc())
                   {
                    ...
                    echo "<td><a class='btn btn-danger' href='Datadelete.php?q=". $HotelID."&r=Tourist'>delete</a></td>"; 
                    echo "</tr>";
                   }
                 }  
                 else
